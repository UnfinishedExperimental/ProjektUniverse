 ...
 * erstellt wird.
 * Im Allgemeinen werden nur IDs > 0 angenommen.
...
public class PJUTReceiverManager
{
	...
	private static PJUTReceiverManager instance;
	
	private HashMap<Byte, PJUTServerReceiver> receivers;
	
	/**
	 * @return vorhandene oder neu erzeugte Instanz
	 */
	public static synchronized PJUTReceiverManager getInstance()
	{
		if(instance == null)
		{
			instance = new PJUTReceiverManager();
		}
	...
	private void setHandlerFor(PJUTServerReceiver receiver,
			PJUTEventHandler handler, byte type)
	{
		if(receiver != null)
		{
	 ...
	 */
	public void setHandlerFor(byte id, PJUTEventHandler handler, byte type)
	{
		if(type > 0)
		{
			PJUTServerReceiver receiver = null;
	 ...
	 * @param type Typ, für den der Handler registriert werden soll
	 */
	public void setHandlerForAll(PJUTEventHandler handler, byte type)
	{
		if(type > 0)
		{
			synchronized(receivers)
