...
import de.fhhof.universe.client.config.KeyBindings;
import de.fhhof.universe.client.config.KeyBindings.CommandType;
import de.fhhof.universe.client.input.PJUTInputDistributor;
import de.fhhof.universe.client.input.commands.BlasterCommand;
import de.fhhof.universe.client.input.commands.MovementCommand;
import de.fhhof.universe.client.input.commands.MovementCommand.MOVE_DIRECTION;
import de.fhhof.universe.client.input.commands.RocketCommand;
import de.fhhof.universe.client.input.commands.RotationCommand;
