...
public class PJUTConnManager implements PJUTServerConnMonitor
{
	...
	private static final PJUTConnManager instance = new PJUTConnManager();
	
	private final HashMap<Byte, PJUTServerSocket> connections;
	 ...
	 */
	public static PJUTConnManager getInstance()
	{		
		return instance;
	}
	...
	public void sendToAll(Serializable o)
	{
		synchronized(connections)
		{
			for(PJUTServerSocket s : connections.values())
			{
				s.send(o);
			}
		}
