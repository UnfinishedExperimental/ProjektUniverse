...
public class ParticleBuffer implements TransparentRO{
    ...
    private void advance(float delta, List<Particle> particles) {
        ...
        for (Particle p : particles) {
            ...
            pos.add(p.getVelocity().mult(delta), pos);
        }
    ...
    private void sortParticles(Matrix4 matrix) {
        List<Particle> top = new LinkedList<Particle>();
        List<Particle> ton = new LinkedList<Particle>();
...
//            pb.addParticle(new Particle(new Vec3f(0, 0, (float) (Math.random() * 1000)),
//                    new Vec3f(), 2, 2));
//        }
        ...
        Particle p = new Particle(new Vec3(), new Vec3(), 1, 1);
